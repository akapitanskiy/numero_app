...
data class Matrix3(
    ...
    companion object {
        operator fun invoke(timeInMillis: Long): Matrix3 {
            ...
            var extra2 = extra11 + extra12
            if (extra2 > 9) {
                extra2 = extra2/10 + extra2%10
            }
            val extra3 = if (list.get(0) != 0) list.sum() - 2 * list.get(0)
                         else list.sum() - 2 * list.get(1)
